...
Features removed are Screen resoltuion as we have made two columns Touchscree, IPS, X-resolution, Y-resolution and Inches as there are only three model of screen (13.3,14,15).
